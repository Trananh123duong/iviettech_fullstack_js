...
import { getProductList } from '../../../redux/thunks/product.thunk'
...
const Home = () => {
  ...
  const applyFilter = (newParams) => {
    ...
    dispatch(
      getProductList({
        ...newParams,
        categoryId: Array.isArray(newParams.categoryId)
          ? newParams.categoryId.join(',')
          : newParams.categoryId,
      })
    )
  }
  ...
  const handleLoadMore = () => {
    ...
    dispatch(
      getProductList({
        ...newFilterParams,
        categoryId: Array.isArray(newFilterParams.categoryId)
          ? newFilterParams.categoryId.join(',')
          : newFilterParams.categoryId,
        more: true,
      })
    )
  }
